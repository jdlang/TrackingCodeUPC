...
process.load('HITrackingStudies.HITrackCorrectionAnalyzer_cfi')
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('trk_GeneralTrack_2.root')
)

# Input source
process.source = cms.Source("PoolSource",
    duplicateCheckMode = cms.untracked.string("noDuplicateCheck"),
    fileNames =  cms.untracked.vstring('file:/Users/jordanlang/Documents/Research/MIT Research/UPC Analysis/Tracking/Data/trk_GeneralTrack.root'),
